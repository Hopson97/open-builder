...
/**
 * @brief Represents a little slice of the world, holding the blocks that make it up
 * 
 */
class Chunk {
  public:
    ...
    /**
     * @brief Quick get block - Gets a block at the local block position without any bounds checking (unsafe)
     * 
    ...
    /**
     * @brief Quick set block - Sets a block at the local block position without any bounds checking (unsafe)
     * 
...
class ChunkManager final {
  public:
     ...
     * 
     * @param blockPosition The position to set the block at
     * @param block The block to set at the position
     */
