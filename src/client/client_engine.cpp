...
ClientEngine::ClientEngine(Window &window)
    : m_window(window)
{
}
...
void ClientEngine::render(const glm::mat4 &projectionMatrix)
{
...
//  =   =   =   =   =   =
void ClientEngine::handlePackets()
{
    Packet incoming;
...
void ClientEngine::handleSnapshot(Packet &packet)
{
    u16 n = 0;
    packet.data >> n;
...
void ClientEngine::handlePlayerJoin(Packet &packet)
{
    client_id_t id = 0;
    packet.data >> id;
...
void ClientEngine::handlePlayerLeave(Packet &packet)
{
    client_id_t id = 0;
    packet.data >> id;
